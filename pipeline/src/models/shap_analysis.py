...
if __name__ == "__main__":
    ...
    # Load trained model
    model_path = Path(__file__).parent.parent.parent.parent / "data/models/success_model.pkl"
    ...
    X_prospects = prospects_2026[feature_cols].fillna(prospects_2026[feature_cols].median())
